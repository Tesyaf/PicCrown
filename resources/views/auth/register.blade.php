...
<head>
    ...
    <style>
        ...
        .blur-circle-1 { animation: float 8s ease-in-out infinite; }
        .blur-circle-2 { animation: float 10s ease-in-out infinite; }
    </style>
</head>
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-100 overflow-hidden">
